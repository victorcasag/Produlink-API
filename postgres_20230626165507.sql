...
1	asdasd	Brazil	asdsad	123	asdwasd	SC	adsasd	12903-881
\.
...
COPY public.client (id, cpf, credit_limit, date_creation, date_of_born, email, last_update, name, name_of_father, name_of_mother, phone, profession, rg, sex, telephone, url_photo, address) FROM stdin;
1	039.219.102-90	777	2020-01-01	2020-01-01	email	2011-11-30	marcel	nome pai	nome mae	(09) 1 3280-9238	profissao	12312311- 	Male	(09) 1 3280-9238		1
\.
...
COPY public.sale_product (id, date_creation, discount, total, sale_id) FROM stdin;
\.
...
COPY public.sales (id, date_creation, discount, price_sale, total_value, client_id, product_id, sale_productid) FROM stdin;
\.
...
--
-- Name: sale_product fk9r7nw142wp5qccenjf2k2uyme; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sale_product
    ADD CONSTRAINT fk9r7nw142wp5qccenjf2k2uyme FOREIGN KEY (sale_id) REFERENCES public.sales(id);
...
--
-- Name: sales fkbmrakxiousuvnp6332xlx7ydl; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sales
    ADD CONSTRAINT fkbmrakxiousuvnp6332xlx7ydl FOREIGN KEY (sale_productid) REFERENCES public.sale_product(id);
...
--
-- Name: sales fkjn262swxllxrcefggvv3clgvh; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sales
    ADD CONSTRAINT fkjn262swxllxrcefggvv3clgvh FOREIGN KEY (client_id) REFERENCES public.client(id);
